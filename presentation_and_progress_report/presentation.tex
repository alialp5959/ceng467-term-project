...
\begin{frame}{Live Demo}
  \begin{center}
    \Huge 🇹🇷 $\leftrightarrow$ 🇬🇧 \\[0.5cm]
    \Large \textbf{Interactive Translation Demo} \\[0.3cm]
    \normalsize Powered by Gradio on Google Colab \\[0.2cm]
    \small \href{https://github.com/alialp5959/ceng467-term-project}{\texttt{github.com/alialp5959/ceng467-term-project}}
  \end{center}
\end{frame}
