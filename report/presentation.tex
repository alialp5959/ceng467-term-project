...
\begin{frame}{Results}
  \begin{table}
    ...
    \begin{tabular}{@{}lcccc@{}}
      ...
      \textbf{Our UNMT}     & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} & \textbf{[TBD]} \\
      Helsinki-NLP (Sup.)   & 30.21 & --   & 31.08 & --    \\ \bottomrule
    \end{tabular}
  \end{table}
  \vfill
  \begin{itemize}
    \item Our unsupervised model outperforms simple baselines
    \item Gap to supervised model shows the difficulty of the task
    \item Turkish morphology remains the biggest challenge
  \end{itemize}
\end{frame}
