...
\begin{frame}{Results}
  \begin{table}
    ...
    \begin{tabular}{@{}lcccc@{}}
      ...
      Our UNMT (1M, 1 IBT)          & 0.09 & 3.92 & 0.10 & 5.85 \\
      Our UNMT (200K, 10 IBT)       & 0.17 & 6.03 & 0.04 & 0.32 \\
      Helsinki-NLP (Sup.)   & 30.21 & --   & 31.08 & --    \\ \bottomrule
    \end{tabular}
  \end{table}
  \vfill
  \begin{itemize}
    \item Original IBT run used incorrect language conditioning
    \item Ten iterations slightly improved TR$\rightarrow$EN, while EN$\rightarrow$TR collapsed
    \item The model did not surpass the word-by-word baseline
  \end{itemize}
\end{frame}
...
\begin{frame}{Conclusion \& Future Work}
  ...
  \begin{itemize}
    ...
    \item Identified why the original system failed to beat the baselines
  \end{itemize}
  \vfill
  \textbf{Future improvements:}
  \begin{itemize}
    \item Correct target-language conditioning and rerun IBT
